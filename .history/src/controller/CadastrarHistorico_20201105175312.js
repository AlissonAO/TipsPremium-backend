...
module.exports = {
  async obterProximaCorrida(req, res) {
    const query = {
      DataCorrida: {
        $lte: new Date('2020-03-11T03:00:00.000+00:00').toISOString(),
        $gte: new Date('2020-03-11T03:00:00.000+00:00').toISOString(),
      },
    };
    await client.connect();
    const database = client.db('premiumTips').collection('historicoCalculado');

    const resultado = await database.aggregate(query).toArray();
