...
module.exports = {
  ...
  async function obterProximaCorrida(req, res){
   
  const uri = "mongodb+srv://tips:alisson123@cluster0.svlya.mongodb.net/tips?retryWrites=true&w=majority";
  const client = new MongoClient(uri, { useNewUrlParser: true });
  client.connect(err => {
    const collection = client.db("premiumTips").collection("historicoCalculado");
    const query = { TrackName : "Central Park"}
       collection.find()
